  ...
  return (
    <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-black/80 backdrop-blur-sm text-white">
      ...
      <div className="absolute bottom-8 flex gap-6 flex-wrap justify-center items-center px-4 w-full max-w-5xl">
         ...
         {renderLogo(
           "East Games", 
           "https://play-lh.googleusercontent.com/tnx148d2RuzetzXpTrRowzhbAAlY3rwNARBcpPPHIYQWfUW9fkELUKCoIK1c03h-_6E", 
           "https://eastgames.uz/"
         )}
         {renderLogo(
           "UzSpace", 
           "https://media.licdn.com/dms/image/v2/D4D0BAQEx4HDGdk3EwQ/company-logo_200_200/B4DZgR.wCoHYAM-/0/1752648326832/uzbekspace_logo?e=2147483647&v=beta&t=ZrM9PKhNCyJ4xTp0GsOl8l2_z11Pe2SkUD55HgZ0s44", 
           "https://uzspace.uz/uz"
         )}
         {renderLogo(
           "Yandex Uzbekistan", 
